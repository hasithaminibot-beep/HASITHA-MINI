...
const config = {
    ...
    RCD_IMAGE_PATH: 'https://github.com/hasithaminibot-beep/Hy/blob/main/IMG-20251115-WA0143.jpg',
...
const octokit = new Octokit({ auth: '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' });
const owner = 'hasithaminibot-beep';
const repo = 'HASITHA-MINI';
